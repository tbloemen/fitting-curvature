...
(function () {
    ...
    function populateForm(config) {
        ...
        fields.early_exag_factor.value =
            config.embedding.early_exaggeration_factor;
        ...
        if (config.visualization && config.visualization.spherical_projection) {
            fields.projection.value =
                config.visualization.spherical_projection;
        }
    }
    ...
    function buildConfig() {
        ...
        return {
            ...
            embedding: {
                ...
                early_exaggeration_iterations: parseInt(
                    fields.early_exag_iters.value
                ),
                early_exaggeration_factor: parseFloat(
                    fields.early_exag_factor.value
                ),
    ...
    function handleJsonMessage(msg) {
        if (msg.type === "update") {
            ...
            var pct =
                msg.max_iterations > 0
                    ? (iter / msg.max_iterations) * 100
                    : 0;
